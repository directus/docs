...
export default defineEventHandler(async (event) => {
  ...
  console.log('logoFileName', logoFileName);
	const baseImagePath = join('/docs/public/img/tutorials', 'background.png');
	const logoContainerPath = join('/docs/public/img/tutorials', 'logo-container.png');
	// const astroLogoPath = join('public/img/tutorials', 'astro.png');
	const logoPath = join('/docs/public/img/tutorials', `${logoFileName}.png`);
