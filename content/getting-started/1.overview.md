...
Directus Cloud is the fastest path to production. Cloud architecture can be complicated and resource-intensive, so Directus Cloud provides scalable, optimized storage and infrastructure, and automatic updates so you can focus on what makes your project special.
...
If you want to run Directus on your own infrastructure, start with Docker Compose in [Create a project](/getting-started/create-a-project).
