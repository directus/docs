...
![Create a new project page on Directus Cloud. Fields include name, region, url, and project template. An area to the side shows Directus Cloud Starter tier is selected at $15 a month.](/img/ed3ace98-6ee8-4b34-b2df-b109eb9bca17.png)
