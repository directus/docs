...
An OIG license is valid for one year from the date it is issued, and its expiration date is shown alongside the license. The grant can be renewed year on year, so eligible entities can keep running Directus beyond the first year.
