...
This is a distinct, send-once message. It is not part of the recurring usage report: it is triggered when an owner is set or changed, rather than sent on the telemetry schedule.
