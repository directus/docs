...
- Scope read on `directus_settings` to the minimum fields your users actually need. Policies created before Directus 12.2.0 grant read on every field. See [Version 12 breaking changes](/releases/breaking-changes/version-12) for the field list applied to new policies.
