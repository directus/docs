...
| Key | Width | Height |
| ---- | ----- | ------ |
| `system-small-cover` | 64px | 64px |
| `system-small-contain` | 64px | - |
| `system-medium-cover` | 300px | 300px |
| `system-medium-contain` | 300px | - |
| `system-large-cover` | 800px | 800px |
| `system-large-contain` | 800px | - |
::
