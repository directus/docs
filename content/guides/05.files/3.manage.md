...
3. Make your changes and click :icon{name="material-symbols:check"} in the top right to save. You can choose to overwrite the original file or save as a new file.

::callout{icon="material-symbols:warning-rounded" color="warning"}
**Irreversible Change**
Saving overwrites the original file on disk. This can't be reversed. Use **Save as New File** to preserve the original.
::

::callout{icon="material-symbols:info-outline"}
**Save as New File** requires create permissions on `directus_files`. The new file inherits the filename and folder of the original, but not manually configured metadata such as title or focal point.
::
