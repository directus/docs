...
::callout{icon="material-symbols:menu-book-outline" color="purple" to="/auth/tokens-cookies"}
...
::callout{icon="material-symbols:menu-book-outline" color="purple" to="/auth/creating-users"}
