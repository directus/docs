...
Similarly, for a One-to-Many relationship, you can filter an item based on properties of its related items. Note that Directus will default to a 'some' search, meaning it will return all values that match.
