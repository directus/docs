...
![Error operation configuration](/img/753d64fc-56cb-4e8d-8007-8343e6a1438e.webp)
...
::callout{icon="material-symbols:warning-rounded" color="warning"}
When using an [Event Hook](/guides/automate/triggers) configured to be "Filter (Blocking)", if your flow ends with an
Error operation, it will cancel your database transaction.
::
