...
Wildcards (`*`, `[*]`) among other special characters are not supported. See the [reference](/guides/connect/json/advanced-querying#path-notation) for the full list.

## More information

For advanced usage and expanded explanations, see [JSON Queries Reference](/guides/connect/json/advanced-querying).
