...
Wildcards (`*`, `[*]`) and other special characters are not currently supported. See the [advanced usage path notation](/guides/connect/json/advanced-querying#path-notation) section for a complete list of unsupported characters.
