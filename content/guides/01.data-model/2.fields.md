...
Each field in the Data Studio includes data attributes that expose the underlying data model information:
 ...
 - `data-primary-key` - The record ID

These atrtibutes enable programmatic field identification for custom styling, extensions, automated testing, and custom tooling.
