...
Visual editing also works in the [**Live Preview**](/guides/content/live-preview#visual-editing-in-live-preview) pane on item detail pages—same editing experience without switching modules.
::
...
When [AI Assistant](/guides/ai/assistant) is available, you can add visual elements as context for AI conversations. Hover over an editable element and click the AI icon to stage it, then open AI Assistant to send your message with the element as context.

<!-- TODO: Screenshot of visual editor with AI icon on hover -->
