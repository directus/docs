...
To archive an item, navigate to the content module and select the desired collection. Select the desired item to open the item page. Click :icon{name="material-symbols:archive-outline"} located in the header and a popup will appear to confirm the action.
