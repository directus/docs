...
::callout{icon="i-lucide-settings" color="primary" to="/guides/content/collaborative-editing/configuration"}
**Configuration**
Configure settings and environment variables.
::

::callout{icon="i-lucide-book-open" color="secondary" to="/guides/content/collaborative-editing/usage"}
**Usage Guide**
Learn the basics of collaborative editing.
::

::callout{icon="i-lucide-square-code" color="green" to="/guides/content/collaborative-editing/development"}
...
::callout{icon="i-lucide-arrow-right" color="primary" to="/guides/content/collaborative-editing/configuration"}
