...
description: Get the most out of AI Chat with practical tips, example prompts, and common pitfalls to avoid.
headline: AI Chat
---
...
See [Tool Behavior](/guides/ai/chat/tools#tool-behavior) for more details.
...
The AI operates with your user permissions. If you're receiving permissions errors in AI Chat, it's likely there the user account doesn't have the necessary permissions to perform the action.

![Permission error example](https://placehold.co/600x300/1E1E32/FFFFFF?text=Permission+Error)
