...
**Conversations:** Stored in your browser only (local storage). Not saved to the server, not shared between devices. See [Data Storage](/guides/ai/chat/usage#data-storage).
