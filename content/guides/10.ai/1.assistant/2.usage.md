...
<!-- TODO: Screenshot of context menu open -->
![Context menu showing Prompts and Content options](/img/ai-chat-context-menu.png)
...
When using the [Visual Editor](/guides/content/visual-editor/studio-module), you can add page elements as context. Click the AI icon on any editable element to stage it. Hovering over visual element cards in the pending context bar highlights the corresponding element on the page.
...
<!-- TODO: Screenshot of pending context bar -->
![Pending context bar with staged items](/img/ai-chat-pending-context.png)

Staged context appears in a horizontal bar above the input. Each card shows an icon and display name—click the **x** to remove. You can add up to 10 context items per message.
