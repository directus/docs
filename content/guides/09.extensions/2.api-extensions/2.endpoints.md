...
The routes of this endpoint are accessible at `{directus_host}:{directus_port}/greet`, `{directus_host}:{directus_port}/greet/intro` and `{directus_host}:{directus_port}/greet/goodbye`.
