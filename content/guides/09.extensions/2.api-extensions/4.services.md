...
::callout{icon="i-lucide-link" to="https://github.com/directus/directus/tree/main/api/src/services"}
...
::callout{icon="i-lucide-link" to="https://github.com/directus/directus/blob/main/api/src/services/items.ts"}
...
::callout{icon="i-lucide-link" to="https://github.com/directus/directus/blob/main/api/src/services/collections.ts"}
...
::callout{icon="i-lucide-link" to="https://github.com/directus/directus/blob/main/api/src/services/relations.ts"}
...
::callout{icon="i-lucide-link" to="https://github.com/directus/directus/blob/main/api/src/services/files.ts"}
