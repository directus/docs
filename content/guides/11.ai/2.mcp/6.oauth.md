...
| ------ | ------ | ------------------- | ------ | ----- |
| Claude Desktop | 2026-05-28 | CIMD preferred. DCR also works. | `MCP_OAUTH_CIMD_ENABLED=true` | Use the Directus MCP URL without static token headers. |
| Claude.ai | 2026-05-28 | CIMD preferred. DCR also works. | `MCP_OAUTH_CIMD_ENABLED=true` | Use the Directus MCP URL without static token headers. |
| Claude Code | 2026-05-28 | CIMD preferred. DCR also works. | `MCP_OAUTH_CIMD_ENABLED=true` | Add the Directus MCP URL with the CLI without static token headers. |
| ChatGPT | 2026-05-28 | DCR | `MCP_OAUTH_DCR_ENABLED=true` | Requires **Advanced OAuth settings** during connector setup. |
| Figma Make | 2026-05-28 | DCR | `MCP_OAUTH_DCR_ENABLED=true` | Use the Directus MCP URL without static token headers. |
| Raycast | 2026-05-28 | DCR | `MCP_OAUTH_DCR_ENABLED=true` | Use the Directus MCP URL without static token headers. |
| v0 | 2026-05-28 | CIMD | `MCP_OAUTH_CIMD_ENABLED=true` | Use the Directus MCP URL without static token headers. |
| VS Code | 2026-05-28 | CIMD | `MCP_OAUTH_CIMD_ENABLED=true` | Does not fall back to DCR. |
| Cursor | 2026-05-28 | DCR | `MCP_OAUTH_DCR_ENABLED=true` | Use the Directus MCP URL without static token headers. |
