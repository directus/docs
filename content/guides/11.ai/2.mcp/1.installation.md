...
::callout{icon="material-symbols:person-add" color="primary" title="Create a dedicated MCP user"}
...
::callout{icon="material-symbols:person" color="warning" title="Use an existing user"}
