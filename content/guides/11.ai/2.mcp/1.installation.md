...
::callout{icon="material-symbols:person-add-outline" color="primary" title="Create a dedicated MCP user"}
...
::callout{icon="material-symbols:person-outline" color="warning" title="Use an existing user"}
