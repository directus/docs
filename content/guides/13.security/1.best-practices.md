...
- Prefer the built-in presets, which are safe by design.
- If you author a custom pattern, avoid nested quantifiers (`(x+)+`, `(x*)*`) and test it against long, non-matching inputs before deploying.
