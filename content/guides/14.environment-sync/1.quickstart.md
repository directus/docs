...
◇ Pulled from source — http://localhost:8055
  ...
  Resources  6 records in 10 resources → directus/default/data
```
...
If a push imports configuration records, it also writes `directus/default/id_map.json`, which remembers which target record each committed record became. Commit it when it changes; [How It Works](/guides/environment-sync/how-it-works#record-identity) explains why.
