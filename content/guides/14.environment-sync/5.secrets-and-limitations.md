...
| Wrap schema and data in **one transaction** | Schema applies first, then data. A failed import re-runs data alone; see [How It Works](/guides/environment-sync/how-it-works#how-a-push-applies).                                           |
