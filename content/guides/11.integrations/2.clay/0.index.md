...
::ProseImg{src="/img/directus_clay_integration.png" alt="Directus Clay Integration Overview" width="400" class="mx-auto"}
::
...
**[📖 Learn how to use Clay Templates with Directus →](/guides/integrations/clay/use-clay-templates-with-directus)**
...
**[📖 Learn how to use Directus Webhooks with Clay →](/guides/integrations/clay/use-directus-webhooks-with-clay)**

## Advanced Topics

Once you're comfortable with the basic integration methods, explore these advanced topics:

**[🔧 Working with Directus Data Operations →](/guides/integrations/clay/directus-clay-data-operations)**
