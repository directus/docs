...
Some Directus field types cannot be synced to Framer. These fields appear as unchecked rows in the mapping screen and cannot be enabled:

- **JSON** - no equivalent type in Framer CMS
- **Array / gallery** - Framer does not support multi-value gallery fields
- **One-to-many, many-to-many, and many-to-any relations** - only many-to-one is supported
