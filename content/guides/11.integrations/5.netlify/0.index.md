...
4. Select **Configure Netlify** to set up the integration
   ...
   - **Team Slug (optional)**: Include your [Team Slug](https://docs.netlify.com/accounts-and-billing/team-management/team-settings/#team-slug) to deploy team sites instead of personal sites
