...
| `extensions.load`              | The extensions payload.               | `payload`                                   |
| `extensions.unload`            | The extensions payload.               | `payload`                                   |
| `extensions.reload`            | The extensions payload.               | `payload`, `added` , `removed`              |
