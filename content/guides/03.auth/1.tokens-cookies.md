...
::callout{icon="i-lucide-book-open" color="primary" to="/guides/auth/email-login"}
...
::callout{icon="i-lucide-book-open" color="primary" to="/tutorials/extensions/validating-third-party-jwts-in-directus"}
