...
Users who have neither are API-only users and do not consume a seat, however many of them you have. See [Key Definitions](/licensing/overview#key-definitions) in the licensing overview for the full seat and collection counting rules.
