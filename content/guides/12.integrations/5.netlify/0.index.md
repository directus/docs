...
**Local development**
Real-time deployment status updates rely on webhooks sent from Netlify to your Directus instance, so your instance must be publicly accessible. If you're developing locally, use a tunneling tool like [ngrok](https://ngrok.com/) or [untun](https://github.com/unjs/untun) to expose your local API.
::
