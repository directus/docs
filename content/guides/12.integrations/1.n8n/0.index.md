...
The Directus community node works with Directus 10 through 12, including Directus Cloud and self-hosted instances.

For most workflows, especially collections without content versioning enabled, no changes are needed when you upgrade to Directus v12.

If you use content versioning, see [Content Versioning](/guides/integrations/n8n/directus-n8n-advanced#content-versioning) for how to read and update draft content from n8n.
