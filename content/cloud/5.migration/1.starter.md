...
While Directus offers both cloud-hosted and self-hosted options, we’ve spent a lot of time looking at how people are using the platform and where we can make the biggest long-term impact. One thing has become clear: the Starter Cloud tier is no longer the right fit for how our community builds with Directus today. After a lot of consideration, we’ve decided to retire this tier and this section of the documentation focuses on migrating a Starter Cloud project to self-hosting.
