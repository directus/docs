...
Each tier includes a set of technical limits, such as seats, API requests, database entries, bandwidth, and asset storage. For the current limits and overage rates across all tiers, see [Cloud Policies](https://directus.com/cloud-policies).
