...
- **Simple CMS** – A ready-to-go content management system (CMS) that you can customise to your needs.

## Project Tiers

The available [project tiers](/cloud/getting-started/introduction) are billed either monthly or annually.
