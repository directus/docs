...
To more accurately gauge the frequency of installation, version fragmentation, and general size of the user base, Directus collects a small amount of usage data about your environment.

| Variable                  | Description                                                       | Default Value                    |
| ------------------------- | ----------------------------------------------------------------- | -------------------------------- |
| `TELEMETRY`               | Allow Directus to collect usage data about your environment.      | `true`                           |
...
For a full breakdown of exactly what data is collected, when it is sent, and how opt-out is affected by your license, see [Telemetry](/licensing/telemetry).
::
