...
The CMS also has a navigation collection that has a header and footer data. You can use the `header` and `footer` fields to set the header and footer in the `Layout` component so it is reusable for all pages.
