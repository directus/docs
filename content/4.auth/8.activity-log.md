...
The activity log module provides a collective timeline of all data-changing actions taken within your project. It is accessed via the notifications tray of the sidebar. The Activity Log page shares the filtering and search with the [Collection Page](/data-modeling/collections).
