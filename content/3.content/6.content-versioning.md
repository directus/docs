...
- **Main**: the main version is the original version of a piece of content that has been created. It is
- the default version that is displayed to users. The main version is the "source of truth" for all other versions. This is often used for published content.
