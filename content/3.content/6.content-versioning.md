...
- **Version**: A version of an item is a snapshot that gets copied from the current or "main" item, allowing you to safely make changes and later promote to be the main version. Any changes to the main version made in the meantime are updated automatically.
