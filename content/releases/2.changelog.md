...
- Added collaborative editing capability to the studio. Full docs available [here](https://directus.io/docs/guides/content/collaborative-editing)
...
- Added AI chat sidebar, read more about it [here](https://community.directus.io/t/introducing-directus-ai-assistant-sidebar-now-in-beta/1699)
- Added the ability to resise and hide both sidebars
