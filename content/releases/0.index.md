...
::callout{icon="i-lucide-link" to="/releases/changelog"}
**The Changelog**
A monthly summary of what's new from the Directus team.
::

::callout{icon="i-lucide-link" to="/releases/breaking-changes"}
**Breaking Changes**
Breaking changes may require action on your part before upgrading.
::

::callout{icon="i-lucide-link" to="https://github.com/directus/directus/releases"}
**Releases**
