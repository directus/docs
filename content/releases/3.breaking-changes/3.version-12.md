...
The `utils/hash/generate` and `utils/hash/verify` endpoints have been removed. The underlying logic governing this functionality can still be utilized however:
