...
::callout{icon="i-lucide-book-open" color="primary" to="/guides/extensions/app-extensions/composables"}
...
::callout{icon="i-lucide-book-open" color="primary" to="/guides/extensions/app-extensions/ui-library"}
...
::callout{icon="i-lucide-graduation-cap" color="secondary" to="/tutorials/extensions"}
